    ...
    return $.get("reflection.coffee", function(reflection) {
      return new ((function() {
        ...
        function _Class() {
          ...
          var i, keyMap, scrollKeys, scrollTop, state, _fn, _i, _ref,
            _this = this;
          ...
          CodeMirror.commands.save = function() {
            return localStorage.state = _this.editor.getValue();
          };
        ...
        _Class.prototype.reflect = function(change) {
        ...
        _Class.prototype.resize = function() {
          var _ref;
          this.windowHeight = $(window).height();
          console.log(this.windowHeight > this.lines);
        ...
        _Class.prototype.drawLine = function(x, y, l, r, g, b, a) {
        ...
        _Class.prototype.sync = function(change) {
          return this.socket.emit("edit", change);
        };

        _Class.prototype.update = function(change) {
          return console.log("update", JSON.stringify(change));
        };
